    ...
    <div className={classes.container}>
      <input
        ...
        className={classnames(`${classes.thumb} ${classes.thumbZindex3}`, {
          [classes.thumbZindex5]: minVal > max - 100
        })}
      />
      <input
        type="range"
      ...
      <div className={classes.slider}>
        ...
        <div className={`${classes.slider__leftValue} ${classes.leftValue}`}>${minVal}</div>
        <div className={`${classes.slider__rightValue} ${classes.rightValue}`}>${maxVal}</div>
      </div>
    </div>
  );
};
